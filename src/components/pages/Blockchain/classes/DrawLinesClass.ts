...
class DrawLinesClass extends Group {
  ...
  constructor(
    ...
    this.material = new ShaderMaterial({
      uniforms: {
        u_time: { type: 'f', value: 0 } as IUniform<any>,
        u_texture: { type: 't', value: null } as IUniform<any>,
        speedEpsilon: { type: 'f', value: 4e-4 } as IUniform<any>,
      },
      vertexShader:
