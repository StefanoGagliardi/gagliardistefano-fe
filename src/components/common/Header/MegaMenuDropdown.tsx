...
export const MegaMenuDropdown: FC = (): ReactElement => {
  // Retrie context
  const { dropdownRefs } = useContext(HeaderContext);

  useEffect(() => {
    if(Array.isArray(dropdownRefs.current) && dropdownRefs.current.length>0) {
      console.log("dropdownRefs: ", dropdownRefs.current[0].current);
      if(Array.isArray(dropdownRefs?.current) && dropdownRefs?.current[0]?.current) {
        dropdownRefs?.current[0]?.current.addEventListener("click", () => {
          console.log("Mouse Enter on element", this);
        })
      }
    }
  }, [dropdownRefs]);
          ...
          <div className={s.dropdownContent}>
            <div className={s.linkGroup}>
              <ul className={s.productsGroup}>
                <li>
                  <a
                    className={cn(s.linkContainer)}
                    href="https://stripe.com/payments"
                  >
                    <svg viewBox="0 0 48 48">
                      <path
                        fill="#87BBFD"
                        className={s['hover-fillLight']}
                    ...
                    <div className={s.productLinkContent}>
                      ...
                      <p className="linkSub">
                        Un completo juego de herramientas de comercio creado
                ...
                <li>
                  <a
                    className="linkContainer item-subscriptions"
                  ...
                  >
                    ...
                    <div className={s.productLinkContent}>
                      <h3 className="linkTitle">Sottoscrizione</h3>
                      <p className="linkSub">
                        Integrazione logiche e sistemi di pagamento alla tua
                        piattaforma
                      </p>
                    </div>
                  </a>
                ...
                <li>
                  <a
                    className="linkContainer item-connect"
                  ...
                  >
                    ...
                    <div className="productLinkContent">
                      ...
                      <p className="linkSub">
                        Todo lo que necesitan las plataformas para facilitar a
                        sus usuarios la recepción de&nbsp;pagos.
                      </p>
                    </div>
                  </a>
                </li>
                <li>
                  <a
                    className="linkContainer item-relay"
                    href="https://stripe.com/relay"
                  >
                    <svg viewBox="0 0 48 48">
                      <path
                        fill="#FFA27B"
                      ...
                      <path
                        fill="#C23D4B"
                        className="hover-fillDark"
                        d="M24 12.5c8.285 0 15 6.828 15 15.25S32.285 43 24 43c-8.284 0-15-6.828-15-15.25S15.716 12.5 24 12.5z"
                      />
                      <path
                        fill="#FFF"
                        d="M25 38.925v6.288a.787.787 0 0 1-.788.787h-.424a.787.787 0 0 1-.788-.788v-6.287c-3.668-.49-6.5-3.623-6.5-7.425a7.5 7.5 0 0 1 15 0c0 3.802-2.832 6.935-6.5 7.425z"
                      />
                    </svg>
                    <div className="productLinkContent">
                      <h3 className="linkTitle">Relay</h3>
                      <p className="linkSub">
                        Vende tus productos en otras aplicaciones&nbsp;móviles.
                      </p>
                    </div>
                  </a>
                </li>
                <li>
                  <a
                    className="linkContainer item-atlas"
                  ...
                  >
                    ...
                    <div className="productLinkContent">
                      ...
                      <p className="linkSub">
                        Una forma nueva de crear un negocio a través
                        de&nbsp;Internet.
                      </p>
                    </div>
                  </a>
                ...
                <li>
                  <a
                    className="linkContainer item-radar"
                  ...
                  >
                    ...
                    <div className="productLinkContent">
                      <h3 className="linkTitle">
                        Radar <span className="new-badge">Nuevo</span>
                      </h3>
                      <p className="linkSub">
                        Herramientas modernas para prevenir el fraude,
                        perfectamente integradas con tus&nbsp;pagos.
                      </p>
                    </div>
                  </a>
                </li>
